...
mkdisk -size=15 -unit=M -path=/home/archivos/fase1/Disco8.disk -fit=BF
...
mkdisk -size=51200 -unit=k -path="/home/archivos/fase1/mis archivos/arc/Disco5.disk" -fit=BF
...
#Monta las particionecaritas Disco1.disk
